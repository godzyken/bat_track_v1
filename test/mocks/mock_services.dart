...
class MockHiveEntityService<T extends JsonModel> extends Mock
    implements HiveEntityService<T> {}

class MockRemoteStorageService extends Mock implements RemoteStorageService {}

class MockSyncedEntityService<T extends JsonModel> extends Mock
    implements SyncedEntityService<T> {}

class MockRemoteEntityServiceAdapter<T extends JsonModel> extends Mock
    implements RemoteEntityServiceAdapter<T> {}

// Helper pour créer des mocks pré-configurés
class MockServiceBuilder {
  static MockHiveEntityService<T> createMockHiveService<T extends JsonModel>() {
