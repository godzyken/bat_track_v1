...
class TechniciensNotifier extends BaseListNotifier<Technicien> {
  @override
  ...
  @override
  Future<List<Technicien>> fetchAll() async {
    final service = ref.read(technicienServiceProvider);
    return service.getAll();
  }

  @override
  Future<void> save(Technicien item) async {
    final service = ref.read(technicienServiceProvider);
  ...
  @override
  Future<void> addItem(Technicien item) async {
    final service = ref.read(technicienServiceProvider);
    await service.save(item);
    state = AsyncValue.data(await service.getAll());
  }
