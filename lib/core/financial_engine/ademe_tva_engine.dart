...
class AdemeTvaEngine {
  ...
  static double getApplicableRate(Produit produit, {bool isEcoRenovation = false}) {
  ...
  static bool _isEcoFriendly(Produit produit) {
    ...
    final bool hasEcoLabel = certs.any((String c) => c.toUpperCase().contains('HQE') || c.toUpperCase().contains('RT2020'));
    final bool hasLowCarbon = (produit.impactCarbone ?? 100) < 50; // Seuil arbitraire pour l'exemple
